...
const BookProductPage = () => {
    ...
    return (
        <div className="pt-28">
            <PageHead
                title={`${title} — Book details | Peter Edochie Legacy`}
                description={product?.excerpt || product?.description || 'View details and pre-register for this Peter Edochie autobiography edition.'}
            />
